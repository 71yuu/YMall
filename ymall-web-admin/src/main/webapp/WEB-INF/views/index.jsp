...
<head>
    ...
    <![endif]-->
    <title>YMall后台管理系统 v1.1</title>
    <meta name="keywords" content="YMall后台管理系统 v1.1,YMall,YMall购物商城后台管理系统">
    <meta name="description" content="YMall后台管理系统 v1.1，是一款电商后台管理系统，适合中小型CMS后台系统。">
</head>
<body>
        ...
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/">YMall后台管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/">YMall后台管理系统</a>
                ...
                <ul class="cl">
                    <li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="javascript:;" onclick="product_add('添加商品','/product/product-add')"><i class="Hui-iconfont">&#xe620;</i> 商品</a></li>
                            <li><a href="javascript:;" onclick="member_add('添加会员','/member/member-add','','630')"><i class="Hui-iconfont">&#xe60d;</i> 用户</a></li>
                        </ul>
                    <li class="navbar-levelone current"><a href="javascript:;">平台</a></li>
                    <li class="navbar-levelone"><a href="javascript:;">财务</a></li>
                    <li ><a href="http://YMall.exrick.cn" target="_blank">商城前台</a></li>
                    </li>
                </ul>
            </nav>
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    ...
                    <li id="LockScreen"> <a href="/user/lock-screen" title="锁屏"><i class="Hui-iconfont" style="font-size:18px">&#xe60e;</i></a> </li>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="/content/content-header-list" data-title="首页导航栏管理" href="javascript:void(0)">首页导航栏管理</a></li>
...
<script type="text/javascript">
    ...
    /*个人信息*/
    function myselfinfo(){
        layer_show('管理员信息','user/admin-show',360,400);
    }
    ...
    $.ajax({
        ...
        success:function (data) {
            if (data.status == 200) {
                $("#role").html(data.data.description);
